...
public class RabbitConfig {
    private static final String OPENCHAT_QUEUE_NAME = "chatbot.queue";
    private static final String OPENCHAT_EXCHANGE_NAME = "chatbot.exchange";
    private static final String ROUTING_KEY = "chatbot.*";
